  ...
  return (
    <div className="max-w-[22rem] w-full h-screen flex flex-col">
      <div className="justify-center flex items-center p-1">
        <h1 className="text-3xl font-bold text-success underline">Chatifyyy</h1>
      </div>
      ...
      <div className="h-[3rem] flex items-center justify-between p-3 border-color-">
        {" "}
        ...
        <button className="btn btn-outline btn-success sm">Logout</button>
      </div>
    </div>
  );
};
